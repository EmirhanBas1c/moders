...
exports.run = async (client, message, args) => {
  let çarpı = client.emojis.get("791422888896888864")
  if (message.author.id !== '854284432181559316') return message.channel.send(çarpı + " Bu komutu sadece `Yapımcım` **kullanabilir!**")
  let nesne = args[0]
  let çarpı2 = client.emojis.get("791422888896888864")
